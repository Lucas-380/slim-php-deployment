...
class Producto{
    ...
    public function crearProducto()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO productos (nombre, sector, tiempoDePreparacion, precio) VALUES (:nombre, :sector, :tiempoDePreparacion, :precio)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, nombre, sector, tiempoDePreparacion, precio FROM productos WHERE nombre = :nombre");
